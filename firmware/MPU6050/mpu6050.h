...
/*
如果MPU6050芯片ADD引脚接地则7位地址为0x68，如果MPU6050芯片ADD引脚接VCC则7位地址为0x69，
但当为读写寻址寻址时，芯片的地址为前七位，最后一位为读写为，
譬如：0x68=01101000为芯片地址，若读写寻址时地址前七位为1101000若为写则第8位为0地址为11010000=0xd0；
若读写寻址时地址前七位为1101000若为写则第8位为1地址为11010001=0xd1；
*/
